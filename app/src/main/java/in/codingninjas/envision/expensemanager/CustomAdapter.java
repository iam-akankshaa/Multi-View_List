    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(t == 1)
        {
            ...
            if(output == null){
                ...
                Log.d("ExpenseAdapter","Inflate Count:");
            ...
            viewHolder.amount.setText(item.getAmount() + " Rs");
        ...
        else
        {
            ...
            if(output == null){
                ...
                TextView headTextView = output.findViewById(R.id.headerTitleTextView);
                HeaderItemViewHolder viewHolder = new HeaderItemViewHolder(headTextView);
                output.setTag(viewHolder);
            }

            HeaderItemViewHolder viewHolder = (HeaderItemViewHolder) output.getTag();
            HeaderItem head = (HeaderItem) itemsList.get(position);
            viewHolder.headerTitleTextView.setText(head.getHeaderTitle());
